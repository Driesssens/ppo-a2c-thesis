...
class BaseAlgo(ABC):
    ...
    def __init__(self, environment_class, acmodel, num_frames_per_proc, discount, lr, gae_lambda, entropy_coef,
        ...
        for i in range(self.num_procs):
            env = instantiate_environment(environment_class)
            env.seed(seed + 10000 * i)
            envs.append(env)

        self.env = ParallelEnv(envs)

        self.preprocess_obss = MyObssPreprocessor(envs[0].observation_space)
